...
import { MapPin, Clock, ArrowLeft, Calendar, Building2, CheckCircle2, AlertCircle, Share2, Bookmark, Download, Sparkles } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-milk px-6">
        <div className="text-center">
          ...
          <button 
            onClick={() => router.push("/")}
            className="bg-primary text-milk px-8 py-3 rounded-2xl font-bold hover:scale-105 transition-all text-sm uppercase tracking-widest"
          >
            Back to Discovery
          </button>
        </div>
              ...
              <div className="prose prose-primary max-w-none">
                ...
                <div className="space-y-12 text-primary/70 text-lg leading-relaxed">
                  {internship.contentBlocks ? internship.contentBlocks.map((block, i) => (
                    ...
                    <p>Loading the ultimate 2000-word guide for {internship.title}...</p>
                  )}
                </div>
              </div>
            </motion.div>
